...
class UnitTestingApplicationTests {
	...
	public void getDataTest(){
		when(repo.findAll()).thenReturn(Stream.of(new Account(1, "Hari", "Saving", 60000), new Account(2, "Haridas", "Current", 90000)).collect(Collectors.toList()));
	...
	public void getDataByIdTest(){
		int id = 2;
		when(repo.findById(id)).thenReturn(java.util.Optional.of(new Account(2, "Hari", "Saving", 60000)));
	...
	public void saveDataTest(){
		Account account = new Account(3, "Samiatrix", "Current", 140000);
...
//		Account user = new Account(8, "Har", "SAVING", 402200);
